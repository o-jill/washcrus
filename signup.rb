...
JAVASCRIPT
  ...
  print "<FORM action='", File.basename($0), "?register' method=post name='signup'>",
    "<TABLE><TR id='trname'><TD>name</TD><TD><INPUT name='rname' id='rname' type=text size=40 required></TD></TR>",
    "<TR id='tremail'><TD>e-mail</TD><TD><INPUT name='remail' id='remail' type=email size=40 required></TD></TR>",
    "<TR id='tremail2'><TD>e-mail(again)</TD><TD><INPUT name='remail2' id='remail2' type=email size=40 required></TD></TR>",
    "<TR id='trpassword'><TD>password</TD><TD><INPUT name='rpassword' id='rpassword' type=password size=40 required></TD></TR>",
    "<TR id='trpassword2'><TD>password(again)</TD><TD><INPUT name='rpassword2' id='rpassword2' type=password size=40 required></TD></TR>",
    "<TR><TD colspan=2><input type='button' value='Submit' onClick='check_form();'></TD></TR></TABLE>"
