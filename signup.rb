...
JAVASCRIPT
  ...
  print "<FORM action='", File.basename($PROGRAM_NAME), "?register' method=post name='signup'>",
    '<TABLE>',
    "<TR id='trname'><TD>name</TD><TD><INPUT name='rname' id='rname' type=text size=25 required></TD></TR>",
    ...
    "<TR><TD colspan=2><input type='button' value='submit' onClick='check_form();'>&nbsp;<input type='reset'></TD></TR>",
    '</TABLE></FORM>'
